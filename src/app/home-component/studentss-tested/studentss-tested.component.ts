...
@Component({
  selector: 'app-studentss-tested',
  templateUrl: './studentss-tested.component.html',
  styleUrls: ['./studentss-tested.component.css'],
})
export class StudentssTestedComponent implements OnInit {
  tests: Test[] = [
    {
      id: 123,
